	   ...
	   function	showHotel(){
			...
			if(hRes[0]!=null){
				...
				/*  var maildataurl="https://mobile.app.link?param=directories.html%26id="+parentid; */
				  var maildataurl="<a href='https://mobile.app.link?param=directories.html%26id="+parentid+"'>https://mobile.app.link?param=directories.html%26id="+parentid+"</a>";
				  ...
				  /* $("#dataurfacebook").attr("data-url",dataurl) */
				   $(".fbshare").attr("id","www.facebook.com/sharer.php?u="+dataurl);
					  ...
					  $("#dataurlemail").attr("href","mailto:?Content-type=text/html&subject=A Guest Services Directory is being shared with you!&body="+maildataurl)
					   ...
					   $('#dataurlwhatsapp').attr("onclick","window.plugins.socialsharing.shareViaWhatsApp('A Guest Services Directory is being shared with you! "+dataurl+"')");
