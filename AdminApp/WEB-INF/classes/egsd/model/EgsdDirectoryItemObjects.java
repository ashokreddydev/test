...
public class EgsdDirectoryItemObjects   {
	...
	private int hotelPictureSize;
	private String picture;
    private String styleId;
    private String phones;
    public int getHotelPictureSize() {
		return hotelPictureSize;
	}
	public void setHotelPictureSize(int hotelPictureSize) {
		this.hotelPictureSize = hotelPictureSize;
	}
	...
	public EgsdDirectoryItemObjects(String objectId, String directoryId,
			...
			String parentReferrence, String locationId, String customizedOrder,int hotelPictureSize) {
		super();
		this.objectId = objectId;
		this.directoryId = directoryId;
		this.title = title;
