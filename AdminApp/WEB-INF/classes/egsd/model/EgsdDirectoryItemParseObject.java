...
public class EgsdDirectoryItemParseObject extends ParseObject {
	...
	//directoryPictureSize
	
	public int getDirectoryPictureSize(){
		return getInt("directoryPictureSize");
	}
	
	public void setDirectoryPictureSize(int value){
		put("directoryPictureSize", value);
	}
